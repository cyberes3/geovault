...
from website.extensions.import_provider import attach_external_ids, collect_external_ids
from geo_lib.processing.logging import DatabaseLogLevel, ImportLog
from geo_lib.types.feature_properties import ingest_raw_properties
...
def process_single_feature(
    ...
    for split_feature in split_features:
        ...
        try:
            ...
            external_ids = collect_external_ids(split_feature)

            split_feature['properties'] = ingest_raw_properties(split_feature.get('properties') or {})
            split_feature['properties'] = geojson_property_generation(split_feature)
            attach_external_ids(split_feature, external_ids)

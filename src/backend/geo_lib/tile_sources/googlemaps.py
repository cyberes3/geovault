...
class GoogleMapsTileSource(TileSource):
    ...
    def url_template(self):
        ...
        # scale=2 requests 512x512 tiles which will be displayed at 256x256 on retina displays
    ...
    def client_config(self):
        return {
            'type': 'xyz',
            'url': '/api/tiles/googlemaps/{z}/{x}/{y}',
            'tileSize': 256  # Display size in CSS pixels (actual tiles are 512x512 for retina)
        }

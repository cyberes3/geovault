 ...
 *   current user's settings - not the raw Vuex store. See `main.js`'s `wrap()` helper.
...
// `platformState` is provided per-route by `createRouteWrapper` (see main.js). It's the only way

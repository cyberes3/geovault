...
from users.views import check_auth, get_user_storage, change_password_api, get_email_status_api, resend_verification_api
...
from users.views.list_users import list_users
...
urlpatterns = [
    ...
    path("api/users/", list_users, name="api_users_list"),
]

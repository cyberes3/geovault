...
object GeoVaultColorTokens {
    ...
    @ColorInt const val BACKGROUND_INT: Int = 0xFFF3F6FA.toInt()
    ...
    @ColorInt const val PURPLE_100_INT: Int = 0xFFF4E6F2.toInt()
    ...
    val Background: Color = Color(BACKGROUND_INT)
    ...
    val Purple100: Color = Color(PURPLE_100_INT)

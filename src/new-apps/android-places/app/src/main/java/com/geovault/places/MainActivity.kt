            ...
            GeoVaultTheme {
                ...
                MainScreen(
                    ...
                    onEditOfflinePlace = { offlineFeature, offlineIndex ->
                        val i = Intent(this, PlaceEditActivity::class.java).apply {
                    ...
                    onNavigatePlace = { feature ->
                        ...
                        if (url != null) {
                            ...
                            PlacesAppServices.from(application).navigationRepository().trackNavigation(
                                feature,
                                GeovaultAuthManager.getServerUrl(this)
                            )
                        }
                    },
                    onDeleteSavedPlace = viewModel::deleteSavedPlace,
                    onRevertOffline = viewModel::revertOfflineChanges,
                    ...
                    onCancelRefresh = {
                        ...
                        Toast.makeText(this, "Cancelled - using cached data", Toast.LENGTH_SHORT).show()
                    },

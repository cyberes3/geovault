            ...
            <section>
              <div class="space-y-2 text-gray-700">
                ...
                <div class="mt-3 px-3 py-2 bg-blue-50 border border-blue-200 rounded-md">
                  <p class="text-sm text-blue-900"><strong>Note:</strong> These credentials are specific to CalTopo's API and are different from your CalTopo login credentials. You don't need to share your CalTopo password. These credentials are also different from any external account provider credentials (Google, Yahoo, MSN, Apple, etc.).</p>
                </div>
              </div>
            </section>
            ...
            <section>
              <div class="space-y-4 text-gray-700">
                <div>
                  ...
                  <p class="text-sm mt-2">Make sure you are signed in to your CalTopo account (you should see your username in the top right corner).</p>
                  ...
                  <div class="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md font-mono text-sm break-all">
                    <a href="https://caltopo.com/app/activate/offline?redirect=localhost" target="_blank" rel="noopener noreferrer" class="text-blue-600 hover:text-blue-800 underline">
                ...
                <div>
                  ...
                  <ol class="list-decimal list-inside ml-4 space-y-1 text-sm">
                    <li>Type a name for "Your device will be synced as" (e.g., "GeoVault Integration" or "caltopo_python") - the exact name is not important, but it will help you keep track of credentials if you have several. This name will appear in the Credentials section of your CalTopo account settings.</li>
                    <li>Check the checkbox to agree to the terms</li>
                    <li>Click the "Sync Account" button</li>
                  </ol>
                  <p class="text-sm mt-2">You may see an error page after clicking "Sync Account" - this is normal and expected.</p>
                </div>
                ...
                <div>
                  ...
                  <p class="text-sm mt-2">The 8-character value after <code class="px-1 py-0.5 bg-gray-200 rounded text-xs">code=</code> from that request URL.</p>
                </div>
                ...
                <div>
                  ...
                  <p class="text-sm mt-2 mb-2">Replace <code class="px-1 py-0.5 bg-gray-200 rounded text-xs">YOUR_8_CHARACTER_CODE</code> with the 8-character code from the previous step.</p>
                  <p class="text-sm mb-2">This should load a page that looks like the following (possibly all compressed into one line):</p>
                  <div class="px-3 py-2 bg-gray-100 border border-gray-300 rounded-md font-mono text-xs overflow-x-auto">
...
`{
  ...
  "key": "xXXXXxXXXXXXXXXxxxXXXXxXxXXXXXXXXXXXX="
                ...
                <div>
                  ...
                  <p class="text-sm">Return to this page and enter the three values you copied into the connection form above. Click "Connect to CalTopo" to complete the setup.</p>
                </div>
              </div>
            </section>
            ...
            <section>
              ...
              <div class="space-y-3 text-gray-700">
                <div>
                  ...
                  <p class="text-sm">Make sure network monitoring is active (red indicator in Network tab) before clicking "Sync Account". Try refreshing the activation page and starting over.</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p class="text-sm">Double-check that you copied all three values correctly, including the full 44-character key. Make sure there are no extra spaces or line breaks.</p>
                </div>
              </div>
            </section>
            ...
            <section>
              <div class="px-3 py-2 bg-red-50 border border-red-200 rounded-md">
                <p class="text-sm text-red-900"><strong>Security Warning:</strong> Your CalTopo credentials are sensitive. Never share them with anyone. They are encrypted when stored in GeoVault, but you should still treat them as confidential.</p>
              </div>
            </section>
          </div>
        </div>

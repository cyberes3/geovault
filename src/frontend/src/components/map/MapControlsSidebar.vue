  ...
  >
    ...
    <div v-if="allowedOptions.mapLayer" class="mb-4 lg:mb-3 xl:mb-4">
      ...
      <select
        ...
        class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 lg:px-2 lg:py-1.5 lg:text-xs xl:px-3 xl:py-2 xl:text-sm"
      >
        <option

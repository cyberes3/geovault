 ...
 * @returns {string} Formatted date string in user's local timezone (e.g., "January 15, 2024 2:30 PM")
 */
export function formatDate(dateString) {
  ...
  try {
    ...
    return moment(dateString).format('LLL'); // e.g., "January 15, 2024 2:30 PM" (localized)
  } catch (error) {

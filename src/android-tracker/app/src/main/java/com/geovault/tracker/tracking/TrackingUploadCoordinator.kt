...
import kotlin.random.Random
    ...
    internal fun TrackingServiceHost.startRetryJob(runGeneration: Int) {
        retryJob?.cancel()
    ...
    internal fun TrackingServiceHost.stopRetryJob() {
        retryJob?.cancel()
        retryJob = null
    }

    internal fun TrackingServiceHost.startBacklogUploader(sessionBoundaryId: Long, runGeneration: Int) {
    ...
    internal fun TrackingServiceHost.stopBacklogUploader() {
        backlogUploaderJob?.cancel()
        backlogUploaderJob = null
    }

    internal fun TrackingServiceHost.startPreflightMonitor(runGeneration: Int) {
        preflightJob?.cancel()
    ...
    internal fun TrackingServiceHost.stopPreflightMonitor() {
        preflightJob?.cancel()
        preflightJob = null
    }

    internal suspend fun TrackingServiceHost.pushQueuedLocations(
    ...
    internal fun TrackingServiceHost.applyQueueUploadResult(
    ...
    internal fun TrackingServiceHost.logQueueUploadResult(result: QueueUploadResult, scope: QueueUploadScope) {
    ...
    internal fun TrackingServiceHost.trimQueuedLocationsRetention(trackerId: String) {
    ...
    internal fun TrackingServiceHost.updateUploadQueueCounts(trackerId: String) {
        if (trackerId.isBlank()) return
    ...
    internal fun TrackingServiceHost.getAuthenticatedHttpClient(): OkHttpClient {
        if (httpClient == null) {

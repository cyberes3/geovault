...
internal enum class MapModeState {
    TRACKING_SINGLE,
    BROWSING_SINGLE,
...
internal enum class MapModeEvent {
    ENTER_TRACKING,
    EXIT_TRACKING,
    SHOW_SINGLE,
    SHOW_ALL_TRACKERS,

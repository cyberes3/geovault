...
import kotlin.random.Random
    ...
    internal fun PositioningRuntime.effectivePositioningPreset(
    ...
    internal fun PositioningRuntime.resolvePointFreshnessIntervalSec(motionMode: TrackingMotionMode): Long {
        return effectivePositioningPreset(motionMode).locationIntervalSec
    }

    internal fun PositioningRuntime.resolveActiveMotionMode(): TrackingMotionMode {
        return autoTrackingMotionEngine.snapshot().mode
    }

    internal fun PositioningRuntime.startSparseTrackingObserver() {
    ...
    internal fun PositioningRuntime.onSparseTrackingChanged() {
    ...
    internal fun PositioningRuntime.currentPositioningRecoveryConfig(): PositioningRecoveryConfig {
        return currentPositioningRuntimeContext(settingsRepository.getSettings()).recoveryConfig
    }

    internal fun PositioningRuntime.currentPositioningRuntimeContext(
        settings: TrackerSettings = settingsRepository.getSettings(),
    ): PositioningContext {
        ...
        return PositioningConfig.resolveContext(
            ...
            val effectiveDistance = elasticDistanceOverrideMeters ?: baseDistance
    ...
    internal fun PositioningRuntime.resolvePointEmissionTrouble(
    ...
    internal fun PositioningRuntime.maybeLogFreshnessProbeDecision(
    ...
    internal fun PositioningRuntime.buildFreshnessRecoveryLocation(
    ...
    internal fun PositioningRuntime.updateRecoveryAnchor(
        location: Location,
        source: String,
        motionMode: TrackingMotionMode,
    ) {

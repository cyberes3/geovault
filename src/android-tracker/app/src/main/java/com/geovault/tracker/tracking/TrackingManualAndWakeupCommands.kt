...
import kotlin.random.Random
    ...
    internal fun TrackingServiceHost.handleManualSendPointCommand(): Boolean {
        if (!isTracking) {
            serviceScope.launch(Dispatchers.Main) {
                Toast.makeText(
                    service,
                    service.getString(R.string.manual_send_point_requires_active_tracking),
                    Toast.LENGTH_SHORT
                ).show()
            }
            return false
        ...
        serviceScope.launch(Dispatchers.IO) {
            ...
            withContext(Dispatchers.Main) {
                Toast.makeText(
                    service,
                    service.getString(R.string.manual_send_point_sent),
                    Toast.LENGTH_SHORT
                ).show()
                triggerLightHaptic()
            }
    ...
    internal fun TrackingServiceHost.getManualSendCandidateLocation(): Location? {
    ...
    internal fun TrackingServiceHost.buildManualSendLocation(source: Location): Location {

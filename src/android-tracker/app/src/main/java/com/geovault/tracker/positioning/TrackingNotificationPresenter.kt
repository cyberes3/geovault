...
internal interface TrackingNotificationGateway {
...
internal class TrackingNotificationPresenter(private val context: Context) : TrackingNotificationGateway {
    ...
    override fun buildTrackingNotification(sentCount: Int, queuedCount: Int, uiStatus: TrackingUiStatus): Notification {
        ...
        val stopIntent = Intent(context, com.geovault.tracker.runtime.TrackingEngineStopReceiver::class.java).apply {
            action = com.geovault.tracker.runtime.TrackerRuntimeCommands.ACTION_ENGINE_STOP
            setPackage(context.packageName)
            putExtra(com.geovault.tracker.runtime.TrackingEngineStopReceiver.EXTRA_REASON, "notification_stop")
        }

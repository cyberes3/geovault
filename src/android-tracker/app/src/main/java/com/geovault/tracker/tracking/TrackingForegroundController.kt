...
import kotlin.random.Random
    ...
    internal fun TrackingServiceHost.failStartup(message: String, path: TrackingServiceIntents.StartupCommandPath, trigger: String, reason: String) {
    ...
    internal fun TrackingServiceHost.failActiveTrackingAndStop(message: String) {
    ...
    internal fun TrackingServiceHost.promoteToForegroundForStartup(
        trigger: String,
        action: String?,
    ...
    internal fun TrackingServiceHost.stopSelfSafelyAfterStartup(reason: String) {
        cleanupServiceResources(reason = reason)
        stopServiceInstance(reason = reason)
    }

    internal fun TrackingServiceHost.logNotificationSurfaceDiagnostics(
        trigger: String,
        action: String?,
        path: TrackingServiceIntents.StartupCommandPath,
        stage: String

...
import kotlin.random.Random
    ...
    internal fun TrackingServiceHost.selectLowAccuracyFallbackCandidate(
    ...
    internal fun TrackingServiceHost.ensureLowAccuracyFallbackTimerRunning() {
    ...
    internal fun TrackingServiceHost.cancelLowAccuracyFallbackTimer(clearCandidate: Boolean) {
    ...
    internal fun TrackingServiceHost.logFallbackWait(reason: String) {
    ...
    internal fun TrackingServiceHost.maybeLogFallbackRejectSummary(nowMs: Long) {
    ...
    internal fun TrackingServiceHost.shouldEmitFallbackForTransition(
...
internal fun TrackingServiceHost.shouldPersistFallbackPoint(
    previousAcceptedLocation: Location?,

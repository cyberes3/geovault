...
import kotlin.random.Random
    ...
    internal fun TrackingServiceHost.requestStartTracking(path: TrackingServiceIntents.StartupCommandPath, trigger: String): Boolean {
    ...
    internal suspend fun TrackingServiceHost.performStartTracking(trigger: String) {
    ...
    internal fun TrackingServiceHost.stopTracking(reason: String, failureReason: String? = null) {
    ...
    internal fun TrackingServiceHost.transitionToStoppedState(failureReason: String?) {
        trackingGeneration++
        isTracking = false
        setStartupInProgress(false)
        startupReadyForEvents = false
    ...
    internal fun TrackingServiceHost.cleanupServiceResources(reason: String) {
    ...
    internal fun TrackingServiceHost.stopServiceInstance(reason: String) {
        GeoVaultCaptureLog.d(TrackingServiceConstants.TAG, "Stopping service instance reason=$reason")
        service.stopSelf()
    }

    internal fun TrackingServiceHost.startLocationUpdates() {
    ...
    internal fun TrackingServiceHost.stopLocationUpdates() {
    ...
    internal fun TrackingServiceHost.setStartupInProgress(value: Boolean) {
        startupInProgress = value
    }

    internal fun TrackingServiceHost.isTrackingActiveOrStarting(): Boolean {

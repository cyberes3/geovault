...
import kotlin.random.Random
    ...
    internal fun TrackingServiceHost.startAutoModeTickIfNeeded() {
    ...
    internal fun TrackingServiceHost.stopAutoModeTick() {
        autoModeTickJob?.cancel()
        autoModeTickJob = null
    }

    internal fun TrackingServiceHost.handleAutoMotionRejectedFix(
    ...
    internal fun TrackingServiceHost.processAutoTrackingOutput(output: AutoTrackingEngineOutput, reason: String) {
    ...
    internal fun TrackingServiceHost.maybeApplyElasticDistanceFilter(observedSpeedMps: Float?, measuredAccuracyMeters: Float?) {
        if (!isTracking) return
        if (
    ...
    internal fun TrackingServiceHost.resetElasticDistanceOverride(reason: String, reapplyRequest: Boolean) {
    ...
    internal fun TrackingServiceHost.computeElasticitySpeedBucket(speedMps: Float?): Int {
    ...
    internal fun TrackingServiceHost.computeElasticDistanceFilterMeters(baseDistanceMeters: Float, speedBucket: Int): Float {

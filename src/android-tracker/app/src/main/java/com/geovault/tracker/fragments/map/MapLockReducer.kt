...
internal sealed interface MapLockEvent {
...
internal object MapLockReducer {
...
internal data class MapLockResumeInput(
...
internal data class MapLockResumeDecision(
    val lockState: MapLockState,
...
internal object MapLockResumeResolver {

...
import kotlin.random.Random
    ...
    internal fun PositioningRuntime.logBackgroundWakeupDiagnostics(
        ...
        val details = "path=$path foregroundStartRequired=$foregroundStartRequired source=$source " +
            ...
            "paused=${state.collectionPace == RecordingPace.Stationary} " +
    ...
    internal fun PositioningRuntime.summarizeLocationForTelemetry(location: Location?): String {
    ...
    internal fun PositioningRuntime.handleLocationUpdateCommand(intent: Intent?): Boolean {

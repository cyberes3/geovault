...
import kotlin.random.Random
    ...
    internal fun TrackingServiceHost.logBackgroundWakeupDiagnostics(
    ...
    internal fun TrackingServiceHost.summarizeLocationForTelemetry(location: Location?): String {
    ...
    internal fun TrackingServiceHost.handleLocationUpdateCommand(intent: Intent?): Boolean {

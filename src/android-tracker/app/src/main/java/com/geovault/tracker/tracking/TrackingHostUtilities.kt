...
import kotlin.random.Random
    ...
    internal fun TrackingServiceHost.isGpsProviderEnabled(): Boolean {
        return locationSessionCoordinator.isGpsProviderEnabled()
    }

    internal fun TrackingServiceHost.readBatteryLevel(): Int {
    ...
    internal fun TrackingServiceHost.isCharging(): Boolean {
    ...
    internal fun TrackingServiceHost.publishTrackPoint(
        trackId: String,
        location: Location,
        propsJson: String?,
    ...
    internal fun TrackingServiceHost.resolveTrackPointQuality(location: Location, propsJson: String?): TrackPointQuality {
    ...
    internal fun TrackingServiceHost.triggerLightHaptic() {
    ...
    internal fun TrackingServiceHost.buildLocalPointPropsJson(location: Location, distanceMeters: Float): String? {
    ...
    internal fun TrackingServiceHost.getDeviceIdentifier(): String {
...
internal fun TrackingServiceHost.isWaitingForProviderState(): Boolean =
    GpsProviderWaitPolicy.isWaitingForProviderState(gpsRuntimeState)

internal fun TrackingServiceHost.resolveObservedSpeedMps(
    location: Location,

...
import kotlin.random.Random
    ...
    internal fun TrackingServiceHost.requestStationaryFreshnessProbe(reason: String): Boolean {
        if (!isTracking) {
    ...
    internal suspend fun TrackingServiceHost.handlePausedFreshnessProbeFix(
    ...
    internal fun TrackingServiceHost.markPausedFreshnessProbeStarted(nowMs: Long) {
    ...
    internal fun TrackingServiceHost.clearPausedFreshnessProbe(
        reason: String,
    ...
    internal fun TrackingServiceHost.logPausedFreshnessDecision(
        eventName: String,
    ...
    internal suspend fun TrackingServiceHost.persistPausedFreshnessPoint(
        selectedTrackerId: String,

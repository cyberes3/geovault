...
object TrackingPolicyProfiles {
    ...
    private const val WALKING_OVERRIDE_MAX_BURST_DISTANCE_METERS = 150.0
    private const val WALKING_OVERRIDE_BURST_WINDOW_SECONDS = 10.0
    private const val WALKING_OVERRIDE_OUTLIER_DISTANCE_MULTIPLIER = 1.3

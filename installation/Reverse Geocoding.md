...
If you want advanced tagging of your features you will have to set up two very heavy services. This feature is disabled by default via the `geocoding.enabled` config value.
